...
const pokemonTypes = [
  { pokemon_id: 1, type_id: 10 }, { pokemon_id: 1, type_id: 11 },
  { pokemon_id: 2, type_id: 10 }, { pokemon_id: 2, type_id: 11 },
  { pokemon_id: 3, type_id: 10 }, { pokemon_id: 3, type_id: 11 },
  { pokemon_id: 4, type_id: 6 },
  { pokemon_id: 5, type_id: 6 },
  { pokemon_id: 6, type_id: 6 }, { pokemon_id: 6, type_id: 17 },
  { pokemon_id: 7, type_id: 4 },
  { pokemon_id: 8, type_id: 4 },
  { pokemon_id: 9, type_id: 4 },
  { pokemon_id: 10, type_id: 8 },
  { pokemon_id: 11, type_id: 8 },
  { pokemon_id: 12, type_id: 8 }, { pokemon_id: 12, type_id: 17 },
  { pokemon_id: 13, type_id: 8 }, { pokemon_id: 13, type_id: 11 },
  { pokemon_id: 14, type_id: 8 }, { pokemon_id: 14, type_id: 11 },
  { pokemon_id: 15, type_id: 8 }, { pokemon_id: 15, type_id: 11 },
  { pokemon_id: 16, type_id: 9 }, { pokemon_id: 16, type_id: 17 },
  { pokemon_id: 17, type_id: 9 }, { pokemon_id: 17, type_id: 17 },
  { pokemon_id: 18, type_id: 9 }, { pokemon_id: 18, type_id: 17 },
  { pokemon_id: 19, type_id: 9 },
  { pokemon_id: 20, type_id: 9 },
  { pokemon_id: 21, type_id: 9 }, { pokemon_id: 21, type_id: 17 },
  { pokemon_id: 22, type_id: 9 }, { pokemon_id: 22, type_id: 17 },
  ...
  { pokemon_id: 31, type_id: 11 }, { pokemon_id: 31, type_id: 14 },
  { pokemon_id: 32, type_id: 11 },
  { pokemon_id: 33, type_id: 11 },
  { pokemon_id: 34, type_id: 11 }, { pokemon_id: 34, type_id: 14 },
  ...
  { pokemon_id: 41, type_id: 11 }, { pokemon_id: 41, type_id: 17 },
  { pokemon_id: 42, type_id: 11 }, { pokemon_id: 42, type_id: 17 },
  { pokemon_id: 43, type_id: 10 }, { pokemon_id: 43, type_id: 11 },
  { pokemon_id: 44, type_id: 10 }, { pokemon_id: 44, type_id: 11 },
  { pokemon_id: 45, type_id: 10 }, { pokemon_id: 45, type_id: 11 },
  { pokemon_id: 46, type_id: 8 }, { pokemon_id: 46, type_id: 10 },
  { pokemon_id: 47, type_id: 8 }, { pokemon_id: 47, type_id: 10 },
  { pokemon_id: 48, type_id: 8 }, { pokemon_id: 48, type_id: 11 },
  { pokemon_id: 49, type_id: 8 }, { pokemon_id: 49, type_id: 11 },
  ...
  { pokemon_id: 62, type_id: 4 }, { pokemon_id: 62, type_id: 2 },
  ...
  { pokemon_id: 69, type_id: 10 }, { pokemon_id: 69, type_id: 11 },
  { pokemon_id: 70, type_id: 10 }, { pokemon_id: 70, type_id: 11 },
  { pokemon_id: 71, type_id: 10 }, { pokemon_id: 71, type_id: 11 },
  { pokemon_id: 72, type_id: 4 }, { pokemon_id: 72, type_id: 11 },
  { pokemon_id: 73, type_id: 4 }, { pokemon_id: 73, type_id: 11 },
  { pokemon_id: 74, type_id: 13 }, { pokemon_id: 74, type_id: 14 },
  { pokemon_id: 75, type_id: 13 }, { pokemon_id: 75, type_id: 14 },
  { pokemon_id: 76, type_id: 13 }, { pokemon_id: 76, type_id: 14 },
  { pokemon_id: 77, type_id: 6 },
  { pokemon_id: 78, type_id: 6 },
  { pokemon_id: 79, type_id: 4 }, { pokemon_id: 79, type_id: 12 },
  { pokemon_id: 80, type_id: 4 }, { pokemon_id: 80, type_id: 12 },
  { pokemon_id: 81, type_id: 5 }, { pokemon_id: 81, type_id: 1 },
  { pokemon_id: 82, type_id: 5 }, { pokemon_id: 82, type_id: 1 },
  { pokemon_id: 83, type_id: 9 }, { pokemon_id: 83, type_id: 17 },
  { pokemon_id: 84, type_id: 9 }, { pokemon_id: 84, type_id: 17 },
  { pokemon_id: 85, type_id: 9 }, { pokemon_id: 85, type_id: 17 },
  { pokemon_id: 86, type_id: 4 },
  { pokemon_id: 87, type_id: 4 }, { pokemon_id: 87, type_id: 7 },
  { pokemon_id: 88, type_id: 11 },
  { pokemon_id: 89, type_id: 11 },
  { pokemon_id: 90, type_id: 4 },
  { pokemon_id: 91, type_id: 4 }, { pokemon_id: 91, type_id: 7 },
  { pokemon_id: 92, type_id: 15 }, { pokemon_id: 92, type_id: 11 },
  { pokemon_id: 93, type_id: 15 }, { pokemon_id: 93, type_id: 11 },
  { pokemon_id: 94, type_id: 15 }, { pokemon_id: 94, type_id: 11 },
  { pokemon_id: 95, type_id: 13 }, { pokemon_id: 95, type_id: 14 },
  ...
  { pokemon_id: 102, type_id: 10 }, { pokemon_id: 102, type_id: 12 },
  { pokemon_id: 103, type_id: 10 }, { pokemon_id: 103, type_id: 12 },
  ...
  { pokemon_id: 111, type_id: 14 }, { pokemon_id: 111, type_id: 13 },
  { pokemon_id: 112, type_id: 14 }, { pokemon_id: 112, type_id: 13 },
  ...
  { pokemon_id: 121, type_id: 4 }, { pokemon_id: 121, type_id: 12 },
  { pokemon_id: 122, type_id: 12 },
  { pokemon_id: 123, type_id: 8 }, { pokemon_id: 123, type_id: 17 },
  { pokemon_id: 124, type_id: 7 }, { pokemon_id: 124, type_id: 12 },
  { pokemon_id: 125, type_id: 5 },
  { pokemon_id: 126, type_id: 6 },
  { pokemon_id: 127, type_id: 8 },
  { pokemon_id: 128, type_id: 9 },
  { pokemon_id: 129, type_id: 4 },
  { pokemon_id: 130, type_id: 4 }, { pokemon_id: 130, type_id: 17 },
  { pokemon_id: 131, type_id: 4 }, { pokemon_id: 131, type_id: 7 },
  ...
  { pokemon_id: 138, type_id: 13 }, { pokemon_id: 138, type_id: 4 },
  { pokemon_id: 139, type_id: 13 }, { pokemon_id: 139, type_id: 4 },
  { pokemon_id: 140, type_id: 13 }, { pokemon_id: 140, type_id: 4 },
  { pokemon_id: 141, type_id: 13 }, { pokemon_id: 141, type_id: 4 },
  { pokemon_id: 142, type_id: 13 }, { pokemon_id: 142, type_id: 17 },
  { pokemon_id: 143, type_id: 9 },
  { pokemon_id: 144, type_id: 7 }, { pokemon_id: 144, type_id: 17 },
  { pokemon_id: 145, type_id: 5 }, { pokemon_id: 145, type_id: 17 },
  { pokemon_id: 146, type_id: 6 }, { pokemon_id: 146, type_id: 17 },
  { pokemon_id: 147, type_id: 3 },
  { pokemon_id: 148, type_id: 3 },
  { pokemon_id: 149, type_id: 3 }, { pokemon_id: 149, type_id: 17 },
...
try {
  ...
  await sequelize.transaction(async (t) => {
    const options = { validate: true, transaction: t };

    await Type.bulkCreate(types, options);
    console.log("✅ Types seeded");

    await Pokemon.bulkCreate(pokemons, options);
    console.log("✅ Pokemons seeded");

    await Team.bulkCreate(teams, options);
    console.log("✅ Teams seeded");

    await sequelize.models.pokemon_type.bulkCreate(pokemonTypes, options);
    console.log("✅ Pokemon_Type seeded");

    await sequelize.models.team_pokemon.bulkCreate(teamPokemons, options);
    console.log("✅ Team_Pokemon seeded");

    // Reset sequences for Postgres (since we forced IDs)
    const tableNames = ['pokemon', 'type', 'team'];
    for (const table of tableNames) {
      await sequelize.query(`SELECT setval('${table}_id_seq', (SELECT MAX(id) FROM "${table}"));`, { transaction: t });
    }
  });
